...
const SupplierTable: React.FC<Props> = ({ suppliers, onRefresh }) => {
                        ...
                        {suppliers.length === 0 ? (
                            ...
                            suppliers.map((supplier) => (
                                <tr key={supplier.id.toString()}>
                                    <td>
                                        <div className="fw-600">{supplier.name}</div>
                                    </td>
                                    <td>
                                        <div className="text-accent">{supplier.domain || '-'}</div>
                                    </td>
                                    <td>
                                        <div className="text-secondary">{supplier.phone || '-'}</div>
                                    </td>
                                    <td>
